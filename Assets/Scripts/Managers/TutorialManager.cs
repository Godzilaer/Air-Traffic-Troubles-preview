...
public class TutorialManager : MonoBehaviour
{
    ...
    private IEnumerator Sequence() {
        ...
        yield return WaitForContinuation();
        ShowTutorialMessage("Wait a few seconds for it fly a little into our radar.");
        ...
        yield return WaitForContinuation();
        ShowTutorialMessage("I've paused the game for a moment. Planes need to land. When you click on one of the yellow boxes on a runway with a plane selected, you are telling it to land.", true);
        yield return WaitForContinuation();
        ...
        yield return WaitForContinuation();
        ShowTutorialMessage("Try to get this plane landed safely before continuing...");
        //detection
        ShowTutorialMessage("Congratulations! You're now a totally certified Air Traffic Controller! Please don't crash any planes... and good luck!");
